...
# Increased --max-semi-space-size to 32MB to allow heap to grow to ~80-100MB (target: 40-50% usage)
CMD ["--expose-gc", "--max-old-space-size=512", "--max-semi-space-size=32", "index2.js"]
