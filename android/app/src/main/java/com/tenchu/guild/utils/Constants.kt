...
object Constants {
    ...
    const val DATABASE_NAME = "tenchu_guild_v2_database" // Changed name to force a fresh start
    
    // Shared Preferences Keys
    const val PREFS_NAME = "tenchu_prefs"
    ...
    // Donation Strings
    const val DONATION_TITLE = "Support Tenchu Guild"
