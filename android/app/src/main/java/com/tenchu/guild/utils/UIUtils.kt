package com.tenchu.guild.utils

import androidx.compose.ui.graphics.Color
import com.tenchu.guild.R
import com.tenchu.guild.models.EventType
import com.tenchu.guild.ui.theme.TenchuGold
import com.tenchu.guild.ui.theme.TenchuPurple
import com.tenchu.guild.ui.theme.TenchuPurpleLight
import com.tenchu.guild.ui.theme.StatusReadyGlow
    ...
    fun getEventStatusColor(startTime: String, endTime: String?, now: Instant, isDark: Boolean): Color {
        return try {
            ...
            when {
                ...
                else -> if (isDark) TenchuPurple else TenchuPurpleLight // Upcoming
            }
        } catch (e: Exception) {
            if (isDark) TenchuPurple else TenchuPurpleLight
        }
    }
