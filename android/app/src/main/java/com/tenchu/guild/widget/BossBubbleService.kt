package com.tenchu.guild.widget
...
import com.tenchu.guild.models.BossTimer
import com.tenchu.guild.models.GuildEvent
import com.tenchu.guild.repository.BossTimersRepository
import com.tenchu.guild.repository.EventsRepository
...
class BossBubbleService : Service() {
    ...
    companion object {
        const val ACTION_SHOW = "com.tenchu.guild.SHOW_BUBBLE"
        const val ACTION_HIDE = "com.tenchu.guild.HIDE_BUBBLE"
    ...
    private fun startForegroundService() {
        ...
        val notification: Notification = NotificationCompat.Builder(this, Constants.BUBBLE_NOTIFICATION_CHANNEL_ID)
            .setContentTitle("Tenchu Bubble Active")
