        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 md:gap-6 w-full md:w-auto">
            ...
            <div className="text-center sm:text-left flex-1">
              ...
              >
                {isWrong ? '🔮 TENCHU 🔮' : isChrono ? '⏰ TENCHU ⏰' : isNightlight ? '🌟 TENCHU 🌟' : isOcean ? '⚓ TENCHU ⚓' : isGrill ? '🔥 TENCHU 🔥' : isPortal ? '🌀 TENCHU 🌀' : isUnstable ? '❓ TENCHU ❓' : isQuantum ? '∞ TENCHU ∞' : isStarlight ? '💜 TENCHU 💜' : isChaos ? '🖍️ TENCHU 🖍️' : isSnack ? '🍖 TENCHU 🍖' : isRoyal ? '👑 TENCHU 👑' : isBlade ? '⚔️ TENCHU ⚔️' : isTiger ? '🐯 TENCHU 🐯' : guildTheme.branding.name}
              </motion.h1>
